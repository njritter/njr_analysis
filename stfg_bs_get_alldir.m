function [m_all,m_avg,m_ste,d_all,d_avg,d_ste] = stfg_bs_get_alldir(stfg,stim)
...
for i = 1:numexps,
    m_all(i,:) = expinfo(i).data.(stim).bs_mmm_avg;
    d_all(i,:) = expinfo(i).data.(stim).bs_dir2_avg;
end;
