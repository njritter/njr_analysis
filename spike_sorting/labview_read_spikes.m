function [times, dirinds, waves, spikewaveforms, EpochStartSamples, EpochNames, header] = labview_read_spikes(ds,name,ref)

% READ_SPIKES - For each channel (name/ref pair), pull out spike
