function labview_write_spikes(ds,clusterids,CI,name,ref,dirlist,dirinds,times)
...
fname_prefix2 = ['intan_st_' name '_' int2str(ref) '_'];
infofname_prefix2 = ['intan_ci_' name '_' int2str(ref) '_'];
...
for i=1:length(dirlist),
	...
	for j=0:20,
		try,
            ...
            delete([dirname filesep fname_prefix2 sprintf('%0.3d', j) '.txt']);
			delete([dirname filesep infofname_prefix2 sprintf('%0.3d', j) '.mat']);
